Pod::Spec.new do |s|
  ...
  s.version           = '1.0.105'
  s.summary           = 'TravelSafelyBoneshell SDK. Build with Apple Swift version 6.3, Xcode:26.4.1 for Metropia with XCFramework with XML Parser realated issue and Xcode version.'
